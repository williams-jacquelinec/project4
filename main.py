...
def main():
    ...
    NW_initialization = NeedlemanWunsch(sub_matrix_file = './substitution_matrices/BLOSUM62.mat', gap_open = -10, gap_extend = -1)
    ...
    for key, value in sorted_alignment_dict.items():
        return key, value   # returns the sequence(aligned to human) and species
